<?php
    ...
    $sql0 = "SELECT net_balance FROM iiitv_bank_record".$id." ORDER BY transaction_id DESC LIMIT 1";
    ...
    $sql_pin = "SELECT * FROM iiitv_bank_client WHERE client_id=".$id." AND client_identification='".$pin."'";
    ...
    if (($result_pin->num_rows) > 0) {
        ...
        if ($type == "credit") {
            ...
            $sql1 = "INSERT INTO iiitv_bank_record".$id." VALUES(
                        NULL,
                        NOW(),
                        'Cash Deposit',
                        '0',
