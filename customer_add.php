    ...
    <form class="add_customer_form" action="customer_add_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="client_name" size="30" type="text" required />
            </div>
            <div  class=container>
                <label>Last Name :</b></label><br>
                <input name="client_surname" size="30" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div class="flex-container-radio">
                <div class="container">
                    <input type="radio" name="client_gender" value="male" id="male-radio" checked>
                    <label id="radio-label" for="male-radio"><span class="radio">Male</span></label>
                </div>
                <div class="container">
                    <input type="radio" name="client_gender" value="female" id="female-radio">
                    <label id="radio-label" for="female-radio"><span class="radio">Female</span></label>
                </div>
                <div class="container">
                    <input type="radio" name="client_gender" value="others" id="other-radio">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="client_aadhar_id" size="25" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="client_email" size="30" type="text" required />
            </div>
            <div  class=container>
                <label>Phone No. :</b></label><br>
                <input name="client_phone" size="30" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <textarea name="client_registered_address" required /></textarea>
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="client_city">
                    <option value="agra">Majra</option>
                    <option value="patna">Sector 23</option>
                    <option value="delhi">Sector 18</option>
                    <option value="kanpur">Sector 19</option>
                    <option value="ahmedabad">Vadodara</option>
                    <option value="gandhinagar">Ahemdabad</option>
                </select>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="client_account_no" size="25" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="net_balance" size="20" type="text" required />
            </div>
            <div  class=container>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="client_username" size="30" type="text" required />
            </div>
            <div  class=container>
                <label>Password :</b></label><br>
                <input name="client_password" size="30" type="text" required />
            </div>
        </div>
