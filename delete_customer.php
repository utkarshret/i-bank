<?php
    ...
    $sql0 = "DELETE FROM iiitv_bank_client WHERE client_id=".$_SESSION['client_id'];
    $sql1 = "DROP TABLE iiitv_bank_record".$_SESSION['client_id'];
    $sql2 = "DROP TABLE iiitv_bank_recipient".$_SESSION['client_id'];
